...
DATA = pathlib.Path("/Users/matthewgrant/projects/ollie/data/1_sold_comps/sold_comps.csv")
pytestmark = pytest.mark.skipif(not DATA.exists(), reason="sold dataset not present")
